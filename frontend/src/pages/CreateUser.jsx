                ...
                >
                  {roles.map(role => (
                    <MenuItem key={role} value={role}>
                      {role === 'L3_APPROVER' || role === 'l3_approver' ? 'Super Admin' : 
                       role === 'L2_APPROVER' || role === 'l2_approver' ? 'Central Expense Controller' :
                       role === 'L1_APPROVER' || role === 'l1_approver' ? 'Regional Manager' :
