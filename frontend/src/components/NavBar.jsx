...
const NavBar = () => {
  ...
  const navItems = [
    ...
    // Only L3 approver (Super Admin) can see admin panel
    { label: 'Admin', path: '/admin', icon: <AdminPanelSettingsIcon />, show: user?.role?.toLowerCase() === 'l3_approver' },
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', gap: 1 }}>
              ...
              >
                <Avatar 
                  ...
                  src={!photoLoadError && user?.profilePicture ? `${config.apiBaseUrl}/users/profile-photo/${user.profilePicture}` : undefined}
                  onError={(e) => {
